...
const nativityScenes = [
  {
    ...
    verses: [
      ...
      { number: 3, text: { it: "è parso bene anche a me, dopo essermi accuratamente informato di ogni cosa dall'origine, di scrivertene per ordine, illustre Teofilo,", en: "Having carefully investigated everything from the beginning, I also have decided to write an accurate account for you, most honorable Theophilus," } },
  ...
  },
  {
    ...
    verses: [
      { number: 5, text: { it: "Al tempo di Erode, re della Giudea, c'era un sacerdote di nome Zaccaria, del turno di Abia; sua moglie era discendente di Aronne e si chiamava Elisabetta.", en: "When Herod was king of Judea, there was a Jewish priest named Zechariah. He was a member of the priestly order of Abijah, and his wife, Elizabeth, was also from the priestly line of Aaron." } },
      ...
      { number: 15, text: { it: "Perché sarà grande davanti al Signore; non berrà né vino né bevande inebrianti, e sarà ripieno di Spirito Santo fin dal grembo di sua madre;", en: "for he will be great in the eyes of the Lord. He must never touch wine or other alcoholic drinks. He will be filled with the Holy Spirit, even before his birth." } },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 28, text: { it: "L'angelo, entrato da lei, disse: «Ti saluto, o favorita dalla grazia; il Signore è con te».", en: "Gabriel appeared to her and said, 'Greetings, favored woman! The Lord is with you!'" } },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 47, text: { it: "e lo spirito mio esulta in Dio, mio Salvatore,", en: "'How my spirit rejoices in God my Savior!'" } },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 67, text: { it: "Zaccaria, suo padre, fu pieno di Spirito Santo e profetizzò, dicendo:", en: "Then his father, Zechariah, was filled with the Holy Spirit and gave this prophecy:" } },
      ...
      { number: 75, text: { it: "in santità e giustizia, davanti a lui, tutti i giorni della nostra vita.", en: "'in holiness and righteousness for as long as we live.'" } },
  ...
  },
  {
    ...
    verses: [
      { number: 1, text: { it: "In quei giorni un decreto di Cesare Augusto ordinò che si facesse il censimento di tutto l'impero.", en: "At that time the Roman emperor, Augustus, decreed that a census should be taken throughout the Roman Empire." } },
      ...
      { number: 7, text: { it: "ed ella diede alla luce il suo figlio primogenito, lo fasciò e lo coricò in una mangiatoia, perché non c’era posto per loro nell’albergo.", en: "She gave birth to her firstborn son. She wrapped him snugly in strips of cloth and laid him in a manger, because there was no lodging available for them." } }
    ],
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 11, text: { it: "Oggi, nella città di Davide, è nato per voi un Salvatore, che è Cristo, il Signore.", en: "'The Savior—yes, the Messiah, the Lord—has been born today in Bethlehem, the city of David!'" } },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 22, text: { it: "Quando furono compiuti i giorni della loro purificazione secondo la legge di Mosè, portarono il bambino a Gerusalemme per presentarlo al Signore,", en: "Then it was time for their purification offering, as required by the law of Moses after the birth of a child; so his parents took him to Jerusalem to present him to the Lord." } },
      ...
      { number: 36, text: { it: "Vi era anche Anna, profetessa, figlia di Fanuel, della tribù di Aser. Era molto avanzata in età: dopo essere vissuta con il marito sette anni dalla sua raggazza,", en: "Anna, a prophet, was also there in the Temple. She was the daughter of Phanuel from the tribe of Asher, and she was very old. Her husband died when they had been married only seven years," } },
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 40, text: { it: "E il bambino cresceva e si fortificava; era pieno di sapienza e la grazia di Dio era su di lui.", en: "There the child grew up healthy and strong. He was filled with wisdom, and God’s favor was on him." } }
    ],
    location: { it: "Nazaret", en: "Nazareth" },
    coordinate: [32.7019, 35.3033],
    image: imgNazaret,
  ...
  },
  {
    ...
    verses: [
      ...
      { number: 49, text: { it: "Ed egli disse loro: «Perché mi cercavate? Non sapevate che io dovevo trovarmi nella casa del Padre mio?»", en: "'But why did you need to search?' he asked. 'Didn’t you know that I must be in my Father’s house?'" } },
      ...
      { number: 52, text: { it: "E Gesù cresceva in sapienza, in statura e in grazia davanti a Dio e agli uomini.", en: "Jesus grew in wisdom and in stature and in favor with God and all the people." } }
    ],
    location: { it: "Gerusalemme - Tempio", en: "Jerusalem - Temple" },
    coordinate: [31.7774, 35.2354],
    image: imgGesuTempio,
